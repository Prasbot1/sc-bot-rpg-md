...
runtime = process.uptime()
	 ...
	 message: { "liveLocationMessage": { "caption":"SC : minta ke owner","h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./src/logo.jpg')}}
	}

					//m.reply(teks)
					let jawab = `\n\nhttps://chat.whatsapp.com/IR483Ml36D9AMfF0MjAHvG`.trim()
